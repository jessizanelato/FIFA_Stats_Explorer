...
def get_players_by_name(name):
    ...
    for result in results:
        player = {
            ...
            'overall': result.i_overall,
            'potential': result.i_potential,
            'age': result.i_age,
            'value': result.i_value,
            'wage': result.i_wage
        }
...
class Player(db.Model):
    ...
    i_overall = db.Column(db.Integer, nullable=False)
    i_potential = db.Column(db.Integer, nullable=False)
    i_age = db.Column(db.Integer, nullable=False)
    i_value = db.Column(db.String, nullable=False)
    i_wage = db.Column(db.String, nullable=False)
    ...
    def __repr__(self):
        return f"{self.i_full_name}({self.i_overall})"
...
def dict_to_dbobject(p):
    new_player = Player(i_full_name=p['info']['full_name'],
                        i_club=p['info']['club'],
                        i_country=p['info']['country'],
                        i_league=p['info']['league'],
                        i_position=p['info']['position'],
                        i_overall=p['info']['overall'],
                        i_potential=p['info']['potential'],
                        i_age=p['info']['age'],
                        i_value=p['info']['value'],
                        i_wage=p['info']['wage'],
...
def dbobject_to_dict(p):
    ...
    j['info']['overall'] = p.i_overall
    j['info']['potential'] = p.i_potential
    j['info']['position'] = p.i_position    
    j['info']['age'] = p.i_age
    j['info']['value'] = p.i_value
    j['info']['wage'] = p.i_wage
